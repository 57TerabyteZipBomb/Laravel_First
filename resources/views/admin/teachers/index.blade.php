    ...
    <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden"
                x-data="{ openAddModal: false, openEditModal: false, openDeleteModal: false, editTeacher: {}, deleteTeacherId: null }">
                ...
                p-4">
                    ...
                    <div x-show="openAddModal" x-transition
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg w-full max-w-2xl p-6 relative">
                            ...
                            @include('admin.teachers.add', ['subjects' => $subjects])
                        </div>
                    </div>

                    @include('admin.teachers.edit', ['subjects' => $subjects])
                            ...
                            @foreach ($teachers as $teacher)
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <button id="what" data-dropdown-toggle={{ $teacher->id }}
                                        ...
                                        <div id={{ $teacher->id }}
                                            ...
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                ...
                                                <li>
                                                    <button
                                                        @click="openEditModal = true; editTeacher = {{ $teacher->toJson() }};"
                                                ...
                                                <li>
                                                    <button
                                                        @click="openDeleteModal = true; deleteTeacherId = {{ $teacher->id }};"
                                                        class="block w-full text-left py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                                        Delete
                                                    </button>
                                                </li>
