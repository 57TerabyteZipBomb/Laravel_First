<div x-show="openEditModal" x-transition class="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg w-full max-w-2xl p-6 relative">
        ...
        <form :action="`/teacher/update/${editTeacher.id}`" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                <div>
                    ...
                    <input type="text" name="name" x-model="editTeacher.name"
                ...
                <div>
                    ...
                    <select name="subject_id" x-model="editTeacher.subject_id"
                        class="bg-gray-50 border border-gray-300 text-sm rounded-lg w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                ...
                <div>
                    ...
                    <input type="email" name="email" x-model="editTeacher.email"
                        class="bg-gray-50 border border-gray-300 text-sm rounded-lg w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                </div>

                <div class="sm:col-span-2">
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Address</label>
                    <textarea name="address" rows="3" x-model="editTeacher.address"
            ...
            <button type="submit" class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 
