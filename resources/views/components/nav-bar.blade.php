        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <x-nav-link href='/new-profile' :active="request()->is('new-profile')">Profile</x-nav-link>

              <x-nav-link href='/new-contacts' :active="request()->is('new-contacts')">Contacts</x-nav-link>
            ...
            <el-dropdown class="relative ml-3">
              <button
                ...
                <img
                  ...
                  alt="" class="size-8 rounded-full outline outline-1 -outline-offset-1 outline-white/10" />
              </button>
              ...
              <el-menu anchor="bottom end" popover
                ...
                <a href="#" class="block px-4 py-2 text-sm text-gray-300 focus:bg-white/5 focus:outline-none">Your
                  profile</a>
                <a href="#"
                  class="block px-4 py-2 text-sm text-gray-300 focus:bg-white/5 focus:outline-none">Settings</a>
                <a href="#" class="block px-4 py-2 text-sm text-gray-300 focus:bg-white/5 focus:outline-none">Sign
                  out</a>
              </el-menu>
            </el-dropdown>
          </div>
